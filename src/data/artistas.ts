...
export const artistas: Artista[] = [
  ...
  { id: 28, nombre: "Intocable", recinto: "Plaza México", ciudad: "CDMX", categoria: "Conciertos", imagen: "/event-palomazo.jpg" },
  ...
  { id: 38, nombre: "Juntos (Jorge Medina & Josi Cuen)", recinto: "Coliseo Centenario", ciudad: "Torreón", categoria: "Conciertos", imagen: "/event-palomazo.jpg" },
